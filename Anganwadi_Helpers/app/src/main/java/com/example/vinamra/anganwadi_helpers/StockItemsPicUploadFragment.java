...
public class StockItemsPicUploadFragment extends Fragment {
    ...
    private String TAG="StockItemsPicUploadFragment";
    ...
    private Button proceedUploadingStockItemsPicsButton;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        stockPicsImageName1="stockitems_pic1_"+parentActivity.getDate()+"_"+parentActivity.getTime();
        stockPicsImageName2="stockitems_pic2_"+parentActivity.getDate()+"_"+parentActivity.getTime();
        ...
        proceedUploadingStockItemsPicsButton=(Button) view.findViewById(R.id.proceedUploadingStockItemsPicsButton);
    ...
    private File createImageFile() throws IOException {
        ...
        if(picNumber==1)
        {
            ...
            imageFileName = "stockitems_pic1_"+ timeStamp;
        }
        else  if(picNumber==2)
        {
            imageFileName = "stockitems_pic2_"+ timeStamp;
        }
    ...
    private void finalizePhoto() {
        ...
        else if(picNumber==2)
        {
            ...
            uploadStockBillBtn.setClickable(false);
            uploadStockBillBtn.setVisibility(View.INVISIBLE);
        }
        ++picNumber;
        idProofViewAlert.dismiss();
    }
    ...
    private void checkPhotoAndUpload() {
        ...
        if(isNetworkConnected (getActivity()))
        {
            ...
            uploadTask[0] = mStorageRef.child("Anganwadi_Helper_images/stock_items_pics/"+ stockPicsImageName1 +".jpg").putFile(uplaodFileURI[0], metadata);
            ...
            uploadTask[0].addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        uploadTask[1] = mStorageRef.child("Anganwadi_Helper_images/stock_items_pics/"+ stockPicsImageName2 +".jpg").putFile(uplaodFileURI[1], metadata);
    ...
    private void saveStockItemsPicsUrlToDatabase() {
        ...
        if(isNetworkConnected(getContext()))
        {
            ...
            saveStockPicsLinkUrl[0]="http://aproject2018.000webhostapp.com/helpertask/saveStockItemsPicsUrl.php?billno="+parentActivity.getBillno()+"&filenumber=pic1&fileurl="+downloadUrl[0];
    ...
    private void urlSaveParseJSONResponse1(String response) {
        try
        {
            ...
            {
                saveStockPicsLinkUrl[1]="http://aproject2018.000webhostapp.com/helpertask/saveStockItemsPicsUrl.php?billno="+parentActivity.getBillno()+"&filenumber=pic2&fileurl="+downloadUrl[1];
