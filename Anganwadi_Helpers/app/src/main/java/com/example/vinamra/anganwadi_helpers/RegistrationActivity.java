...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private void initializeViews() {
        ...
        toolbar.setTitle(getResources().getString(R.string.registration_form));
        ...
        final RegistrationTabsAdapter adapter = new RegistrationTabsAdapter(getSupportFragmentManager());
