...
public class HelperDetailsVerifyActivity extends AppCompatActivity {
    ...
    private ImageView idProofVerifyImageView;
    ...
    private void initialize() {
        ...
        avatarView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                /*Glide.with(HelperDetailsVerifyActivity.this)
        ...
        idProofVerifyImageView = (ImageView) findViewById(R.id.idProofVerifyImageView);
        idProofVerifyImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        Log.d("HelperDetailsVerifyACtivity",helperProofUrl);
        ...
        Glide.with(HelperDetailsVerifyActivity.this)
                ...
                .into(new SimpleTarget<Bitmap>() {
                    @Override
                    public void onResourceReady(Bitmap resource, GlideAnimation<? super Bitmap> glideAnimation) {
                        idProofVerifyImageView.setImageBitmap(resource);
                    }
                });

        //onclick of avatar or imageview open Dialog for full size view
    }
