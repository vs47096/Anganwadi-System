...
public class HelperDetailsViewActivity extends AppCompatActivity {
    ...
    private DismissibleImageView idProofViewBtn;
    ...
    private void initialize() {
        ...
        idProofViewBtn= (DismissibleImageView) findViewById(R.id.idProofViewBtn);
        ...
        Log.d("HelperDetailsView",helperProofUrl);
        ...
        if(contact2.equals(""))
        {
            contact2View.setVisibility(View.GONE);
        }
