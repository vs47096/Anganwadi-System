...
public class NewHelperActivity extends AppCompatActivity {
    ...
    private ActionProcessButton createHelperAccountButton,generate_id_pass;
    ...
    private void initializeView() {
        ...
        generate_id_pass = (ActionProcessButton) findViewById(R.id.generate_id_pass);
        ...
        createHelperAccountButton= (ActionProcessButton) findViewById(R.id.createHelperAccountButton);
    ...
    private void checkAvailabilityOfID(String generatedUserID) {
        generate_id_pass.setMode(ActionProcessButton.Mode.ENDLESS);
        generate_id_pass.setProgress(1);
        if(generatedUserID.equals(""))
        {
            generate_id_pass.setProgress(0);
    ...
    private void newhelpertempdatastorage() {
        ...
        else
        {
            ...
            p.setMessage(getString(R.string.creating_helpers_account));
