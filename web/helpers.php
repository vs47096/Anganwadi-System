	...
	<div id="page">
		...
		<div id="fh5co-project">
			<div class="container">
				...
				$query = mysqli_query($conn,"SELECT * FROM  HelpersTable");
				$count = mysqli_num_rows($query);
				if($count == "0"){
					echo  "<h2>No result found!</h2>";
				}else{
				      echo "<div class='table-users' style='width:1000px;';>
                            <div class='header' style='line-height:1.7; padding:20px;'>Helpers Records</div>
					...
					while($row = mysqli_fetch_array($query)){
						...
						$picurl=$row['photo_url'];
						
						$picurltoken=$row['photo_url_token'];
					    ...
					    $picurl =  strstr($picurl,"Anganwadi_Helper_images",true).str_replace("/","%2F",strstr($picurl,"Anganwadi_Helper_images"))."&token=".$picurltoken;
                        ...
                        echo"<td ><img style='cursor:pointer;' src='".$picurl."' onclick='disblock(this)'> </td>";
		...
		<form class="modal-content animate" action="/action_page.php">
			...
			<div class="container" style="height:500px;">
				<div class="imgcontainer">
					...
					<?php
					echo "<img src=". $picurl. " id='blockpick' alt='Image' style='width:50%; height:430px;' class='avatar'>";
					?>
				</div>
			</div>
