	...
	<div id="page">
		...
		<div id="fh5co-project">
			<div class="container">
				...
				$query = mysqli_query($conn,"SELECT * FROM Supervisor");
				$count = mysqli_num_rows($query);
				if($count == "0"){
					$output = '<h2>No result found!</h2>';
				}else{
				      echo "<div class='table-users'>
                            <div class='header'>Supervisor Details</div>
					...
					while($row = mysqli_fetch_array($query)){
                        ...
                        echo "<td>" . $row['anganwadi_name'] . "</td>";

        				echo "<td>" . $row['supervisor_logged_in'] . "</td>";
